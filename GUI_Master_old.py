...
#
lbl = tk.Label(root, text="Retinal disease classification using deep learning", font=('times', 35,' bold '), height=1, width=60,bg="light blue",fg="black")
lbl.place(x=0, y=3)


frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=350, bd=5, font=('times', 14, ' bold '),bg="light blue")
